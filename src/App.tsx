...
function App() {
  ...
  const [dragPosition, setDragePosition] = useState<number | undefined>(undefined);
  ...
  useEffect(() => {
    if(topRef.current && splitterRef.current && bottomRef.current && containerSize) {
      updateEl(topRef.current, getPosition(containerSize, ElementType.Top, dragPosition));
      updateEl(splitterRef.current, getPosition(containerSize, ElementType.Splitter, dragPosition));
      updateEl(bottomRef.current, getPosition(containerSize, ElementType.Bottom, dragPosition));
    }
